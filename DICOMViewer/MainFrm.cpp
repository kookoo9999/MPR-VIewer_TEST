...
BEGIN_MESSAGE_MAP(CMainFrame, CFrameWndEx)
	...
	ON_COMMAND(ID_CHECK_SCA, &CMainFrame::OnCheckSca)
	ON_UPDATE_COMMAND_UI(ID_CHECK_SCA, &CMainFrame::OnUpdateCheckSca)
END_MESSAGE_MAP()
...
void CMainFrame::OnUpdateCheckSca(CCmdUI *pCmdUI)
{
